...
import {me} from "$providers/actions/cart"


let meStore =  me.load(); 
let d ;
meStore.subscribe((val)=>{
	console.log("123 ",val)	
	d = val;
})
							...
							<div class="row">
								...
								<div class="col-sm-3" >
									<div class="thumb-wrapper">
										<div class="img-box">
											<img src={v.coverImage.url} class="img-fluid" alt="">
										</div>
										<div class="thumb-content">
											<h4>{v.title}</h4>
											<p class="item-price"><strike>$400.00</strike> <span>{v.data}</span></p>
